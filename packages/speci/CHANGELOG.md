...
- correct @abapify/speci/client doc reference to use /rest subpath ([7b4a368c](https://github.com/abapify/adt-cli/commit/7b4a368c))
...
This was a version bump only for speci to align it with other projects, there were no code changes.
